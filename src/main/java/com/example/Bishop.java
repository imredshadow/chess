...
public class Bishop extends Piece {
    ...
    // TO BE IMPLEMENTED!
    // return a list of every square that is "controlled" by this piece. A square
    // iscontrolled
    // if the piece capture into it legally.
    // Pre-condition: Board is an 8x8 array that is not null
    // Post-condition: An ArrayList of squares the piece controls no matter
    // whooccupies it
    ...
    // belogical and it should never move off the board!
    // returns an arraylist of squares which are legal to move to
    // please note that your piece must have some sort of logic. Just being able
    // tomove to every square on the board is not
    // going to score any points.
    // Piece: Bishop
    /*
     * Rules: The bishop can only move diagonally (forward or back)
     * //and cannot jump over other pieces. The bishop never changes the color
     * square
     * it is on.
     * There are two bishops on the board at the start.
     */
    // Precondition: The Board object (b) must not be null and will be a 64
    // squareboard. The start square must be within board b (0-7).
    // Postcondition: Returns an ArrayList of possible moves the piece could move
    // to(based on the rules of the piece movement)
